...
This application provides a FastAPI server for processing vehicle registration cards
and extracting structured information using the Qwen 2.5 Vision model.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Vehicle Registration Card OCR API Server')
    ...
    print("\n========================================")
    print(" Vehicle Registration Card OCR API Server")
    print("========================================")
